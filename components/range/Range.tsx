...
import styles from '@/styles/components/range/Range.module.scss';
import type { RangeProps } from '@/interface/settings/settings.interface';

export default function Range(props: RangeProps): React.JSX.Element {
