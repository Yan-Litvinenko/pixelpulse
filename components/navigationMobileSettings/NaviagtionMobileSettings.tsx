...
import styles from '@/styles/components/navigationMobileSettings/NavigationmobileSettings.module.scss';
...
export default function NavigationMobileSettings(): React.JSX.Element {
    ...
    React.useEffect(() => {
        setMusicClass(getClassState(musicState));
        setSoundsClass(getClassState(soundsState));
    }, [soundsState, musicState]);
