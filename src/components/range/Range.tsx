...
const Range = (props: IRange): React.JSX.Element => {
    ...
    const progress: React.MutableRefObject<HTMLDivElement | null> =
        React.useRef(null);
    const customThumb: React.MutableRefObject<HTMLDivElement | null> =
        React.useRef(null);
    ...
    const [rangeValue, setRangeValue] = useRange(
        inputValue,
        setRefProgress,
        setRefThumb,
    );
    ...
    return (
        <label className={styles.range}>
            ...
            <div className={styles.range__box}>
                ...
                <div
                    className={styles.range__custom_thumb}
                    ref={customThumb}
                ></div>
            </div>
        </label>
